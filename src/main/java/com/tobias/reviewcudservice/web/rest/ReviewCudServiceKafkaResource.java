...
import com.tobias.reviewcudservice.config.KafkaSseConsumer;
import com.tobias.reviewcudservice.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/review-cud-service-kafka")
public class ReviewCudServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ReviewCudServiceKafkaResource.class);
    ...
    public ReviewCudServiceKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
